...
export default function ScenarioComparison({ analysis }: ScenarioComparisonProps) {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <Card variant="danger" className="w-full">
          <div className="text-center">
            <p className="text-sm font-semibold text-red-400 mb-1">또 사면</p>
            ...
            <div className="rounded-lg bg-red-500/15 px-4 py-3">
              <p className="text-xs text-zinc-500 mb-0.5">손실 확률</p>
              <p className="text-2xl font-extrabold text-red-400">{buyScenario.lossRate}%</p>
            </div>
          </div>
        </Card>
        ...
        <Card variant="success" className="w-full">
          <div className="text-center">
            <p className="text-sm font-semibold text-emerald-400 mb-1">이번엔 끊으면</p>
            ...
            <div className="rounded-lg bg-emerald-500/15 px-4 py-3 mb-3">
              <p className="text-xs text-zinc-500 mb-0.5">수익 확률</p>
              <p className="text-2xl font-extrabold text-emerald-400">{waitScenario.gainRate}%</p>
            </div>

            <div className="rounded-lg bg-emerald-500/15 px-4 py-3">
      ...
      <p className="text-center text-zinc-500 text-sm italic mt-6">이 결말을 알고도 사시겠습니까?</p>
    </div>
  );
}
