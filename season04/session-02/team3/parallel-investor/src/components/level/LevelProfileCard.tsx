...
export default function LevelProfileCard({ level, nickname }: LevelProfileCardProps) {
  ...
  return (
    <Card className="relative overflow-hidden">
      ...
      <div className="absolute -right-8 -top-8 h-32 w-32 rounded-full bg-blue-500/5" />
      ...
      <div className="relative flex flex-col items-center gap-5 py-4">
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-sm font-bold text-blue-400">Lv.</span>
            <span className="text-6xl font-extrabold tracking-tight text-zinc-100">
              {level.level}
            </span>
          </div>
        </div>
